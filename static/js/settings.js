...
function toolRailItems() { return ["#brushTool", "#bucketTool", "#mosaicEraserTool", "#eraserTool", "#excludeBucketTool", "#excludeEraserTool", "#boundaryTool", "#singleViewButton", "#compareViewButton", "#fitButton", "#undoButton", "#redoButton", "#mosaicPreviewButton"].map($); }
