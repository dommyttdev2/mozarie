...
function toolRailItems() { return ["#brushTool", "#bucketTool", "#mosaicEraserTool", "#eraserTool", "#excludeBucketTool", "#excludeEraserTool", "#boundaryTool", "#fitButton", "#undoButton", "#redoButton", "#mosaicPreviewButton"].map($); }
