...
| --- | --- | --- |
| 必須: 性器の自動検出 | `nsfw-anime-xl-x1280.onnx` | Mozarieでダウンロード、または[固定配布元](https://huggingface.co/01miku/anime-nsfw-segm-yolo26/resolve/1697d5d1827b6a818b350b44bf3ec27f08837a2a/nsfw-anime-xl-x1280.onnx)から取得。保存先: `Mozarie\models\ultralytics\nsfw-anime-xl-x1280.onnx` |
